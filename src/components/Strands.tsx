...
export default function Strands({
  ...
  useEffect(() => {
    ...
    // Respect the user's motion preference and skip WebGL entirely for browsers
    // that do not support it, keeping the site usable and within budget.
    ...
    try {
      ...
      return; // WebGL unavailable — the page renders fine without the backdrop.
    }
    ...
    if (reduceMotion) {
      // Draw a single static frame so the backdrop is present but never animates.
      update(0);
    } else {
